...
namespace TestBot
{
    class Program
    {
        ...
        public static async Task Start()
        {
            ...
            {
                Debug = new ClientDebugConfig { LogRestRequestJson = true, LogRestRequest = true, LogWebSocketFull = true, LogWebSocketReady = true, LogWebSocketError = true, LogWebSocketUnknownEvent = true }
            });
