...
[Serializable]
#endif
public struct Optional<T, TException> : IEquatable<Optional<T, TException>>, IComparable<Optional<T, TException>>
{
    ...
    internal Optional(T value, TException exception, bool hasValue = true)
    {
        this.value = value;
    ...
    public bool Equals(Optional<T, TException> other)
    {
    ...
    /// <returns>A boolean indicating whether or not the optionals are equal.</returns>
    public override bool Equals(object obj) => obj is Optional<T, TException> ? Equals((Optional<T, TException>)obj) : false;
    ...
    /// <returns>A boolean indicating whether or not the optionals are equal.</returns>
    public static bool operator ==(Optional<T, TException> left, Optional<T, TException> right) => left.Equals(right);
    ...
    public int CompareTo(Optional<T, TException> other)
    {
    ...
    public static bool operator <(Optional<T, TException> left, Optional<T, TException> right) => left.CompareTo(right) < 0;
    ...
    /// <returns>The existing or alternative value.</returns>
    public T ValueOrDefault(Func<TException, T> alternativeFactory)
    {
        if (alternativeFactory == null) throw new ArgumentNullException(nameof(alternativeFactory));
    ...
    internal Optional<T, TException> Or(T alternative) => hasValue ? this : Optional.Some<T, TException>(alternative);
    ...
    /// <param name="alternativeFactory">A factory function to create an alternative value.</param>
    /// <returns>A new optional, containing either the existing or alternative value.</returns>
    internal Optional<T, TException> Or(Func<T> alternativeFactory)
    {
        if (alternativeFactory == null) throw new ArgumentNullException(nameof(alternativeFactory));
        return hasValue ? this : Optional.Some<T, TException>(alternativeFactory());
    }
    ...
    /// <param name="alternativeFactory">A factory function to map the exceptional value to an alternative value.</param>
    /// <returns>A new optional, containing either the existing or alternative value.</returns>
    internal Optional<T, TException> Or(Func<TException, T> alternativeFactory)
    {
        if (alternativeFactory == null) throw new ArgumentNullException(nameof(alternativeFactory));
        return hasValue ? this : Optional.Some<T, TException>(alternativeFactory(exception));
    }
    ...
    internal Optional<T, TException> Else(Optional<T, TException> alternativeOption) => hasValue ? this : alternativeOption;
    ...
    /// <returns>The alternative optional, if no value is present, otherwise itself.</returns>
    internal Optional<T, TException> Else(Func<Optional<T, TException>> alternativeOptionFactory)
    {
    ...
    /// <returns>The alternative optional, if no value is present, otherwise itself.</returns>
    internal Optional<T, TException> Else(Func<TException, Optional<T, TException>> alternativeOptionFactory)
    {
        if (alternativeOptionFactory == null) throw new ArgumentNullException(nameof(alternativeOptionFactory));
    ...
    internal Optional<T> WithoutException()
    {
        return Match(
            some: value => Optional.Some(value),
            none: _ => Optional.None<T>()
        );
    }
    ...
    internal TResult Match<TResult>(Func<T, TResult> some, Func<TException, TResult> none)
    {
    ...
    internal void Match(Action<T> some, Action<TException> none)
    {
        if (some == null) throw new ArgumentNullException(nameof(some));
        if (none == null) throw new ArgumentNullException(nameof(none));
    ...
    /// </summary>
    /// <param name="none">The action to evaluate if the value is missing.</param>
    internal void MatchNone(Action<TException> none)
    {
        if (none == null) throw new ArgumentNullException(nameof(none));
    ...
    internal Optional<TResult, TException> Map<TResult>(Func<T, TResult> mapping)
    {
        if (mapping == null) throw new ArgumentNullException(nameof(mapping));

        return Match(
            some: value => Optional.Some<TResult, TException>(mapping(value)),
            none: exception => Optional.None<TResult, TException>(exception)
        );
    }
    ...
    /// <param name="mapping">The transformation function.</param>
    /// <returns>The transformed optional.</returns>
    internal Optional<T, TExceptionResult> MapException<TExceptionResult>(Func<TException, TExceptionResult> mapping)
    {
        if (mapping == null) throw new ArgumentNullException(nameof(mapping));

        return Match(
            some: value => Optional.Some<T, TExceptionResult>(value),
            none: exception => Optional.None<T, TExceptionResult>(mapping(exception))
        );
    }
    ...
    /// <param name="mapping">The transformation function.</param>
    /// <returns>The transformed optional.</returns>
    internal Optional<TResult, TException> FlatMap<TResult>(Func<T, Optional<TResult, TException>> mapping)
    {
        if (mapping == null) throw new ArgumentNullException(nameof(mapping));
    ...
    /// <returns>The transformed optional.</returns>
    internal Optional<TResult, TException> FlatMap<TResult>(Func<T, Optional<TResult>> mapping, TException exception)
    {
        if (mapping == null) throw new ArgumentNullException(nameof(mapping));
    ...
    /// <returns>The transformed optional.</returns>
    internal Optional<TResult, TException> FlatMap<TResult>(Func<T, Optional<TResult>> mapping, Func<TException> exceptionFactory)
    {
        if (mapping == null) throw new ArgumentNullException(nameof(mapping));
    ...
    internal Optional<T, TException> Filter(bool condition, TException exception) =>
        hasValue && !condition ? Optional.None<T, TException>(exception) : this;
    ...
    /// <param name="exceptionFactory">A factory function to create an exceptional value to attach.</param>
    /// <returns>The filtered optional.</returns>
    internal Optional<T, TException> Filter(bool condition, Func<TException> exceptionFactory)
    {
        if (exceptionFactory == null) throw new ArgumentNullException(nameof(exceptionFactory));
        return hasValue && !condition ? Optional.None<T, TException>(exceptionFactory()) : this;
    }
    ...
    /// <param name="exception">The exceptional value to attach.</param>
    /// <returns>The filtered optional.</returns>
    internal Optional<T, TException> Filter(Func<T, bool> predicate, TException exception)
    {
        if (predicate == null) throw new ArgumentNullException(nameof(predicate));
        return hasValue && !predicate(value) ? Optional.None<T, TException>(exception) : this;
    }
    ...
    /// <param name="exceptionFactory">A factory function to create an exceptional value to attach.</param>
    /// <returns>The filtered optional.</returns>
    internal Optional<T, TException> Filter(Func<T, bool> predicate, Func<TException> exceptionFactory)
    {
        if (predicate == null) throw new ArgumentNullException(nameof(predicate));
        if (exceptionFactory == null) throw new ArgumentNullException(nameof(exceptionFactory));
        return hasValue && !predicate(value) ? Optional.None<T, TException>(exceptionFactory()) : this;
    }
    ...
    /// <param name="exception">The exceptional value to attach.</param>
    /// <returns>The filtered optional.</returns>
    internal Optional<T, TException> NotNull(TException exception) =>
        hasValue && value == null ? Optional.None<T, TException>(exception) : this;
    ...
    /// <param name="exceptionFactory">A factory function to create an exceptional value to attach.</param>
    /// <returns>The filtered optional.</returns>
    internal Optional<T, TException> NotNull(Func<TException> exceptionFactory)
    {
        if (exceptionFactory == null) throw new ArgumentNullException(nameof(exceptionFactory));
        return hasValue && value == null ? Optional.None<T, TException>(exceptionFactory()) : this;
    }
}
