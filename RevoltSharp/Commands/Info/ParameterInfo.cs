...
public class ParameterInfo
{
    ...
    public async Task<PreconditionResult> CheckPreconditionsAsync(CommandContext context, object arg, IServiceProvider services = null)
    {
    ...
    public async Task<TypeReaderResult> ParseAsync(CommandContext context, string input, IServiceProvider services = null)
    {
        services = services ?? EmptyServiceProvider.Instance;
