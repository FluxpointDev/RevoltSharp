...
namespace RevoltSharp.Commands.Builders
{
    public class ModuleBuilder
    {
        ...
        public ModuleBuilder AddCommand(string primaryAlias, Func<CommandContext, object[], IServiceProvider, CommandInfo, Task> callback, Action<CommandBuilder> createFunc)
        {
